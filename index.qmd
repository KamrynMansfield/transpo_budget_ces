...
- The amount of budget allocated to transportation is more than it was a century ago [@johnson_century_2001] but, in the past few decades it hasn't changed much [@bureau_of_transportation_statistics_transportation_2024]
...
- [@mattson_relationships_2020] Car ownership, family size, income, housing type, and other location factors are connected with transportation expenditures. 
...
- Lower income households spend a bigger percent of their budget on transportation (transportaiton burdened) [@molloy_new_2024]

**This is my start at trying to talk about the statistics**

A major portion of a household's expenditures is allocated to transportation. The amount people spend on transportation has clearly increased in the last century, but has stayed roughly in the range of 15 - 20 percent over the last few decades. In 2023, the average household spent approximately 17 percent of their budget on transportation [@johnson_century_2001; @bureau_of_transportation_statistics_transportation_2024]. Looking at individual households, the transportation share of household expenditures varies widely. Lower income households seem to be more burdened by transportation expenses as it often takes up a larger portion of their overall expenses [@molloy_new_2024]. 

Besides income, there are many other factors that play a role in the way households spend money on transportation, including car ownership, family size, housing type, and other location factors. For example, larger family sizes and living in single-family homes both tend to be correlated with increased transportation spending [@mattson_relationships_2020]. 

Car ownership has been increasing, with less than 10 percent of carless households in 2023 compared to over 20 percent in 1960. Before 1980, there was a larger portion of one-car households compared to two-car households. Since then, the number of two-car households has surpassed the number of one-car households. 
...
Data for the following analysis were attained from the 2024 Consumer Expenditure Survey (CEX) Public Use Microdata (PUMD). The CEX is deployed continuously by the Bureau of Labor Statistics (BLS). The data are organized by quarter and published each year. The CEX consists of two surveys as described below. 
...
We grouped the `r length(expense_types)` different types of expenditures found in the data into the following `r length(categories)` categories: `r categories`

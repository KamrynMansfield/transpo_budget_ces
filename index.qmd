...
transpo_cats |> 
  ...
  row_group_order(c("Car Purchase",
                    "Car Maintenance",
                    "Car Fuel",
                    "Car Payment",
                    "Bus Travel",
...
Highlights of @tbl-data-demographics
...
demog_tbl <- read.csv("data/tables/ce_demog_vs_census.csv") |>
...
### Some More Results
I think @tbl-model-covarpcts is showing what percent of households fall into each category in each class. But I just put this in here to look at it. It won't be in the final paper.

{{< embed notebooks/LCA.qmd#tbl-model-covarpcts >}}
...
## Appendix A: Spending Category Breakdown {#sec-appendix-a}

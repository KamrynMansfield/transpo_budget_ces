...
{{< embed notebooks/category_spending_table.qmd#tbl-transpo-spending >}}


**The next big thing to do with the data section is to write about the demographics and compare them to census data.** 
find census data : 
https://www.census.gov/quickfacts/fact/table/US/PST045224
https://data.census.gov/table


{{< embed notebooks/demographic_tbl.qmd#tbl-data-demographics >}}

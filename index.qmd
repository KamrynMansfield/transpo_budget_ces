...
Lower income households seem to be more burdened by transportation expenses as it often takes up a larger portion of their overall expenses [@molloy_new_2024]. 

Larger family sizes and living in single-family homes both tend to be correlated with increased transportation spending [@mattson_relationships_2020]. 
...
@tbl-lit-summary summarizes the literature that was reviewed for this study. As seen in the table, there were a total of `r nrow(lit_rev_tbl)` studies reviewed with `r nrow(lit_rev_tbl[!is.na(lit_rev_tbl[["Use Consumer Expenditure Survey Data"]]),])` studies that use the consumer expenditure survey.

{{< embed notebooks/lit_review_table.qmd#tbl-lit-summary >}}

The literature relating to this study has been classified into four groups: (1) Household Choices and Activity Patterns, (2) Household Transportation Choices, (3) Household Spending and Budgets, and (4) Household Transportation Budgets. The following sections describe the relevant findings from literature in each of these groups.

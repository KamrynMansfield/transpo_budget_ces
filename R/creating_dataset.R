...
expd_csv_path <- "data/CE_data/2023/diary23_combined/expd.csv"
fmld_csv_path <- "data/CE_data/2023/diary23_combined/fmld.csv"
col_def_csv_path <- "data/CE_data/2023/diary23_combined/column_descriptions/fmld_col_descr.csv"
pumd_dictionary_xlsx_path <- "data/CE_data/ce-pumd-interview-diary-dictionary.xlsx"
ucc_categories_xlsx_path <- "data/CE_data/2023/ucc_categories.xlsx"
binary_columns_xlsx_path <- "data/CE_data/2023/diary23_combined/column_creation_binary/fmld_col_binary.csv"
...
# save to a file
save_to_path <- "data/CE_data/2023/diary23_combined/created_data/exp_fmly_data_new.csv"

...
create_nice_coeff_tbl(model_df, 
                      ...
                      row_group_order = c("Intercept",
                                          "Reference Age (55 or older)",
                                          "Education (No college degree)",
                                          "Income (more than $50,000)",
                                          "Household Structure (Single without children)",
                                          "Region (not Northeast)"  ,
                                          "Population Size (Below 1 million)" ,
                                          "Mandatory Expenses (none)" ,
                                          "House Expenses (none)"   ,
                                          "Food Expenses (<$100)",
                                          "Leisure Expenses (none)"))
```
...
labsC1 <- c("Zero", "FiftyB", "FiftyHundred", "HighHunB")
...
expense_variable_names <- matrix(c("Class Probability", "Class Probability",
         "carFuelP_cat1"  , "Car Fuel Expense",
         "carMainP_cat1"  , "Car Maintenance Expense",
         "taxiP_cat1"       , "Ridesharing Expense",
         "busP_cat1"     , "Transit (Bus) Expense",
         "trainP_cat1"   , "Transit (Rail) Expense" ,
         "airP_cat1"        , "Air Travel Expense",
         "microP_cat1"      , "Microtransit Expense"),
 byrow = T, ncol = 2) |>
  as.data.frame()
...
expense_level_names <- matrix(c("NA"  ,"",  
                                "Zero", "None",  
                                "FiftyB" ,"$0.01 - $50.00",
                                "HundredB", "$0.01 - $100.00",
                                "HighHunB" , "$100.00 +",
                                "TwentyB" , "$0.01 - $20.00",
                                "TwentyFifty" , "$20.01 - $50.00",
                                "HighFifB", "$50.01 +",
                                "Any", "Any",
                                "HighTwB", "$20.01 +",
                                "FiveHB" , "$0.01 - $500.00",
                                "HighFive", "$500.01 +",
                                "FiftyHundred","50.01 - $100.00"),
                              byrow = T, ncol = 2) |>
  as.data.frame()
...
create_nice_probs_table(final_model, 
                        ...
                        row_group_order = c("Class Probability",
                                            "Car Fuel Expense",
